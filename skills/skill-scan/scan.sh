...
#
# Usage:
#   ./skills/skill-scan/scan.sh <path-to-SKILL.md>
#   ./skills/skill-scan/scan.sh skills/my-skill/SKILL.md
#   ./skills/skill-scan/scan.sh --all              # Scan all skills
#   ./skills/skill-scan/scan.sh --all --json        # JSON output
#
# Exit codes:
